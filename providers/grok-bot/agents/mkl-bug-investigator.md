# mkl-bug-investigator

Investigate a reported bug, isolate a minimal reproduction, and return evidence plus the next useful action.
...
4. Ask: "Save this validated workflow as a skill called mkl-bug-investigator."
